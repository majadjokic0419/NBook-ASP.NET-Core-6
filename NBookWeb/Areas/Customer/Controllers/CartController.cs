...
namespace NBookWeb.Areas.Customer.Controllers
{
    [Area("Customer")]
    [Authorize]
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            //if user is not a company user then go forward with Stripe settings
            ...
            //If it is a company user redirect to an order confirmation page
            else
            {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _unitOfWork.ShoppingCart.RemoveRange(shoppingCarts);// remove items from a cart when order is placed
            _unitOfWork.Save();
            return View(id);
        }
